...
with_snippet_options(step: 'testing-the-custom_web_site-resource', cwd: '~/learn-chef/cookbooks') do
  ...
  snippet_code_block 'hello_world_test-default-test-rb' do
    file_path '~/learn-chef/cookbooks/custom_web/test/smoke/default/default_test.rb'
    content lazy { ::File.read(::File.expand_path('~/learn-chef/cookbooks/custom_web/test/smoke/default/default_test.rb')) }
  end
