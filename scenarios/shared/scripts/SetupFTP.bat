...
SET FtpSiteName=passiveftp
SET FtpDirectory=C:\vagrant
SET PublicPort=21
SET DynamicPortFirst=10000
SET DynamicPortLast=10125
...
REM appcmd set config %FtpSiteName% /section:system.ftpserver/security/authorization /-[users='*'] /commit:apphost
